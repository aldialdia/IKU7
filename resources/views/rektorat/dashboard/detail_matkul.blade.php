    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
            <a href="{{ route('rektorat.dashboard') }}">Dashboard</a>
        </li>
        <li class="breadcrumb-item">
            <a href="{{ route('rektorat.dashboard.fakultas', $matakuliah->departemen->id_fakultas) }}">
                {{ $matakuliah->departemen->fakultas->Nama_fakultas }}
            </a>
        </li>
        <li class="breadcrumb-item">
            <a href="{{ route('rektorat.dashboard.departemen', $matakuliah->id_departemen) }}">
